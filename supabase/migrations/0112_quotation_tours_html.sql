-- Novo bloco "Passeios e Ingressos" na cotação: mesmo padrão do Itinerário/Aéreo
-- alternativo — texto livre rico (fonte/cor/foto), pra colar prints de ingresso
-- de parque, link de passeio, preços etc.
alter table public.travel_proposals
  add column if not exists tours_html text;
