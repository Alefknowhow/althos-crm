-- Segunda conexão de voo (opcional) — RPC pública passa a devolver
-- stopover2_code/stopover2_city/stopover2_wait também.
  ...
  return jsonb_build_object(
    ...
    'flights', coalesce((
      select jsonb_agg(jsonb_build_object(
        ...
        'duration_label', p.data->>'duration_label',
        'stopover_code', p.data->>'stopover_code', 'stopover_city', p.data->>'stopover_city', 'stopover_wait', p.data->>'stopover_wait',
        'stopover2_code', p.data->>'stopover2_code', 'stopover2_city', p.data->>'stopover2_city', 'stopover2_wait', p.data->>'stopover2_wait',
