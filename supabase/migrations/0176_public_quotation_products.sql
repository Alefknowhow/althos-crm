-- get_public_quotation passa a ler quotation_products (Aéreo/Hospedagem
-- migrados na 0175) em vez de quotation_lodgings/quotation_flights.
-- Formato do jsonb devolvido pro front (`lodgings`/`flights`) é mantido
-- IDÊNTICO ao anterior — PublicQuotationView não muda por causa disso.
