-- get_public_quotation precisa expor os campos novos de voo
-- (departure_time/arrival_date/arrival_time/flight_number) pra
-- PublicQuotationView poder renderizá-los na proposta pública —
-- mesma função de 0112_quotation_tours_html.sql, só o bloco "flights"
-- do jsonb_agg mudou.
