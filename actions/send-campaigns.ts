...
// listCampaigns/getCampaignDetail/cancelCampaign/resendFailedRecipient/
// deleteCampaignDraft moved to ./send-campaigns-manage.ts (este arquivo
// passou do limite de 350 linhas do lint).
