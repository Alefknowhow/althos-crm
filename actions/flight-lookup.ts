...
import {
  RAPIDAPI_HOST, toIata, parseUtc, fmtDuration, parseSegment, fetchOneFlight, normalizeStatus, sleep,
  type FlightLookupResult, type FlightStatusResult,
} from '@/lib/travel/flight-lookup-helpers'
 ...
 *
 * Helpers de parsing/formatação e a chamada HTTP em si vivem em
 * lib/travel/flight-lookup-helpers.ts (este arquivo passou do limite de 350
 * linhas do lint — e um arquivo 'use server' só pode exportar async functions).
 */

export type { FlightLookupResult, FlightStatusResult }
