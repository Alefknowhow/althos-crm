...
/**
 * Roteirista — core actions (access check, CRUD, chat). Split out of
 * actions/roteirista.ts, which is now a pure re-export barrel (a 'use
 * server' file can't re-export from another module, only export async
 * functions defined directly in it — see roteirista.ts's header comment).
 */
