...
// Feature labels + helpers de leitura (planHasFeature, minimumPlanFor,
// getPlanMeta, formatPlanPrice) movidos pra ./labels.ts (este arquivo
// passou do limite de 350 linhas do lint). Reexportados aqui só por
// compatibilidade com imports existentes (`from '@/lib/plans/config'`);
// prefira importar de '@/lib/plans/labels' em código novo.
export { FEATURE_LABELS, planHasFeature, minimumPlanFor, getPlanMeta, formatPlanPrice } from './labels'
