/**
 * Precificação de Althos Credits por modelo/ação de IA — separado de
 * lib/plans/config.ts (que ultrapassou o limite de 350 linhas do lint).
 * Mesma regra de negócio, arquivo próprio.
 */
