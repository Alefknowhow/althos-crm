...
- **Apostas e jogos de azar ilegais:** divulgação de casas de aposta, cassinos, jogos de azar ou *bets* não autorizados por lei, incluindo loterias, rifas, sorteios ou esquemas de apostas não regulamentados. Tais atividades, além de violarem nossa política, geralmente afrontam a legislação e as diretrizes da própria API do WhatsApp/Meta.
- **Golpes e fraudes:** mensagens de teor fraudulento ou enganoso que visem obter vantagem indevida ou causar prejuízo a terceiros — por exemplo, golpes do tipo "sua encomenda foi apreendida na alfândega, pague uma taxa para liberar", tentativas de *phishing*, falsas cobranças em nome de instituições, promoções fraudulentas, entre outros. Esses conteúdos configuram abuso da plataforma e potencialmente crime de estelionato ou outras fraudes contra os consumidores.
- **Mensagens não solicitadas (spam) sem base legal:** envio de mensagens a contatos que não consentiram com o recebimento ou em relação aos quais o usuário não possui base legal adequada nos termos da Lei Geral de Proteção de Dados (LGPD). A Althos CRM é uma ferramenta de relacionamento com clientes e leads legítimos — não um instrumento de disparo massivo a listas frias, compradas ou obtidas de forma irregular.
- **Uso indevido do atendente de IA:** emprego dos recursos de inteligência artificial e dos créditos de IA da plataforma para gerar conteúdo fraudulento, enganoso, difamatório, discriminatório ou que se faça passar indevidamente por outra pessoa, empresa ou autoridade.
- **Conteúdo ilegal ou ilícito em geral:** qualquer utilização da Althos CRM para disseminar material que não esteja em conformidade com as leis vigentes — incluindo mensagens que promovam atividades criminosas, produtos/serviços proibidos ou qualquer material que infrinja direitos de terceiros, viole a ordem pública ou estes Termos de Uso. Conteúdos enganosos, ofertas fictícias ou que de qualquer forma induzam os destinatários a erro não serão tolerados.

> **Observação:** Estas restrições estão alinhadas às políticas oficiais do WhatsApp Business e da Meta, que proíbem terminantemente o uso da API para facilitação de jogos de azar com dinheiro real, esquemas fraudulentos ou mensagens *spam* que surpreendam ou lesem os usuários.
...
- **Papéis sob a LGPD:** o Usuário (a clínica ou empresa titular da conta) atua como **Controlador** dos dados pessoais que insere, importa ou coleta por meio da plataforma, sendo responsável por determinar as finalidades e os meios de tratamento. A Althos CRM atua como **Operadora**, realizando o tratamento em nome e segundo as instruções do Usuário.
- **Base legal e consentimento:** cabe exclusivamente ao Usuário garantir que possui base legal adequada (consentimento, execução de contrato, legítimo interesse etc.) para armazenar contatos e enviar mensagens por meio da plataforma. A importação de listas obtidas de forma irregular, a compra de bases de dados ou o envio de mensagens sem autorização do destinatário constituem violação destes Termos e da legislação.
- **Integridade multi-tenant:** sendo a Althos CRM uma plataforma compartilhada por múltiplos clientes, é terminantemente proibido tentar acessar, extrair ou interferir em dados, contas ou ambientes de outros usuários. Tentativas de invasão, escalonamento de privilégios ou acesso não autorizado a outros *tenants* configuram violação gravíssima e poderão ser comunicadas às autoridades.
- **Direitos dos titulares:** a Althos CRM disponibilizará ao Usuário (Controlador) os meios técnicos razoáveis para atender solicitações de titulares de dados (acesso, correção, exclusão), permanecendo o Usuário como responsável primário por essas respostas perante os titulares.
