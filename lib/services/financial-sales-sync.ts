...
import { nextDecendioPaymentDate,nextOperatorPaymentDate,nextSemanalPaymentDate } from '@/lib/financial/operator-payment';
import type { ActionContext } from './context';

export async function syncSaleRevenueEntryCore(ctx: ActionContext, sale: {
