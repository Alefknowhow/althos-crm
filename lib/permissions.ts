...
export const PERMISSION_MODULES: PermissionModule[] = [
  ...
  { key: 'estoque_clinica', label: 'Estoque', section: 'Clínicas' },
...
const NON_TRAVEL_ONLY_KEYS = new Set<PermissionKey>(['sales', 'calendar', 'profissionais', 'orcamentos_clinica', 'atendimentos_clinica', 'tratamentos_clinica', 'lista_espera_clinica', 'comissoes_clinica', 'prontuario_clinica', 'estoque_clinica', 'imoveis', 'seguros', 'trafego'])
