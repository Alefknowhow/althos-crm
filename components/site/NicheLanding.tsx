    ...
    <SiteShell>
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-2">
            {c.heroChips.map((chip) => (
              <span
                key={chip}
                className="inline-flex items-center gap-2 rounded-lg border border-[#383838] bg-[#262626] px-3 py-1.5 text-[13px] font-medium text-[#a8a8a8]  "
              >
      ...
      <section className="relative mx-auto max-w-5xl px-4 py-14 sm:px-6 sm:py-20">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-2xl font-bold tracking-tight text-[#f4f4f4] sm:text-3xl">
            Soa familiar?
          </h2>
          <p className="mx-auto mt-3 max-w-lg text-[14px] text-[#a8a8a8] sm:text-base">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2">
          {c.dores.map((d) => (
            <div
              key={d.t}
              className="rounded-none border border-[#383838] bg-[#262626] p-5   sm:p-6"
            >
              <div className="flex items-start gap-3">
                <span className="mt-0.5 flex h-8 w-8 flex-none items-center justify-center rounded-lg border border-red-800/50 bg-red-500/10 text-red-400">
                  <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={2.2}>
                    <path d="M18 6L6 18M6 6l12 12" />
                  </svg>
                </span>
                <div>
                  <h3 className="text-[15px] font-semibold text-[#f4f4f4] sm:text-base">{d.t}</h3>
                  <p className="mt-1.5 text-[13.5px] leading-relaxed text-[#a8a8a8] sm:text-sm">{d.d}</p>
                </div>
              </div>
            </div>
          ))}
      ...
      {/* Como resolve */}
      <section className="relative border-y border-[#383838] bg-[#1f1f1f]">
        <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6 sm:py-20">
          <div className="mx-auto max-w-2xl text-center">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[#4589ff]/40 bg-[#0f62fe]/10 px-3 py-1 text-xs font-medium text-[#78a9ff]">
              Como a Althos resolve
            </span>
            <h2 className="mt-4 text-2xl font-bold tracking-tight text-[#f4f4f4] sm:text-3xl">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {c.resolve.map((r) => (
              <div
                key={r.n}
                className="relative rounded-none border border-[#383838] bg-[#262626] p-6  "
              >
                <span className="text-sm font-bold text-[#0f62fe]">{r.n}</span>
                <h3 className="mt-3 text-lg font-semibold text-[#f4f4f4]">{r.t}</h3>
                <p className="mt-2 text-[14px] leading-relaxed text-[#a8a8a8]">{r.d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {c.recursos.map((f) => (
            <div key={f.t} className="rounded-none border border-[#383838] bg-[#262626] p-5   sm:p-6">
              <span className="flex h-9 w-9 items-center justify-center rounded-lg border border-[#4589ff]/40 bg-[#0f62fe]/10 text-[#0f62fe]">
                <svg viewBox="0 0 24 24" className="h-[18px] w-[18px]" fill="none" stroke="currentColor" strokeWidth={2.2}>
                  <path d="M20 6L9 17l-5-5" />
                </svg>
              </span>
              <h3 className="mt-4 text-[15px] font-semibold text-[#f4f4f4] sm:text-base">{f.t}</h3>
              <p className="mt-1.5 text-[13.5px] leading-relaxed text-[#a8a8a8] sm:text-sm">{f.d}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="relative border-y border-[#383838] bg-[#1f1f1f]">
        <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20">
          <div className="text-center">
            <h2 className="text-2xl font-bold tracking-tight text-[#f4f4f4] sm:text-3xl">Na prática</h2>
            <p className="mx-auto mt-3 max-w-lg text-[14px] text-[#a8a8a8] sm:text-base">
          ...
          <ul className="mt-9 space-y-3">
            {c.casos.map((caso, i) => (
              <li
                key={i}
                className="flex items-start gap-3 rounded-none border border-[#383838] bg-[#262626] px-5 py-4  "
              >
                <span className="mt-0.5 flex h-6 w-6 flex-none items-center justify-center rounded-full bg-[#4589ff]/15 text-[#0f62fe]">
                  <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth={2.6}>
                    <path d="M20 6L9 17l-5-5" />
                  </svg>
                </span>
                <span className="text-[14px] leading-relaxed text-[#d4d4d4]">{caso}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <section className="relative mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20">
        <h2 className="text-center text-2xl font-bold tracking-tight text-[#f4f4f4] sm:text-3xl">
        ...
        <div className="mt-8 space-y-3">
          {c.faq.map((item) => (
            <details
              key={item.q}
              className="group rounded-none border border-[#383838] bg-[#262626] px-5 py-4   [&_summary]:cursor-pointer"
            >
              <summary className="flex items-center justify-between gap-4 text-[15px] font-semibold text-[#f4f4f4] marker:content-['']">
                {item.q}
                <span className="flex h-6 w-6 flex-none items-center justify-center rounded-full border border-[#525252] text-[#707070] transition-transform group-open:rotate-45">
                  <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth={2.2}>
                    <path d="M12 5v14M5 12h14" />
                  </svg>
                </span>
              </summary>
              <p className="mt-3 text-[14px] leading-relaxed text-[#a8a8a8]">{item.a}</p>
            </details>
          ))}
        </div>
      </section>
