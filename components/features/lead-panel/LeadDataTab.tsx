...
import {
  ...
  uploadContatoAvatar, removeContatoAvatar, resolveContatoAvatars,
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="space-y-2">
        ...
        <Input value={cpf} onChange={e => setCpf(e.target.value)} className="h-9" placeholder="000.000.000-00" />
        <label className="block text-xs text-muted-foreground">Data de nascimento</label>
        <Input value={dateOfBirth} onChange={e => setDateOfBirth(e.target.value)} className="h-9" type="date" />
