...
import {
  Loader2, ExternalLink, FileSignature, Plane, Camera, Trash2, Plus,
} from 'lucide-react'
import { CONTATO_STATUS_META, type ContatoStatus } from '@/lib/contatos'
import {
  createContato, uploadContatoAvatar, removeContatoAvatar, getContatoTravelLinks,
  type ContatoQuoteLink, type ContatoReservationLink,
} from '@/actions/contatos'
import { fmtDate, fmtCurrency, initials, STATUS_VALUES, type ListRow } from './ContatosViewShared'
