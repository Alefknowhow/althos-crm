import { Plus, Send, Pencil, X } from 'lucide-react'
import {
...
/**
 * Modal dialogs used by SocialInbox: confirm action, image-queue composer,
 * and image lightbox. Split out of SocialInbox.tsx — purely presentational,
 * all state/handlers passed in as props.
 */

export function ConfirmActionDialog({
  confirmAction, setConfirmAction, selectedConversation, actionLoading, onConfirm,
}: {
...
export function ImageComposerDialog({
  pendingImages, setPendingImages, composerIndex, setComposerIndex,
  editingImage, setEditingImage, closeImageComposer, handleApplyEditedImage,
  removePendingImage, composerFileInputRef, handleComposerAddMore,
  sendingQueue, handleSendImageQueue,
}: {
  pendingImages: PendingImage[]
  setPendingImages: React.Dispatch<React.SetStateAction<PendingImage[]>>
  composerIndex: number
  setComposerIndex: React.Dispatch<React.SetStateAction<number>>
...
export function LightboxDialog({ lightboxUrl, setLightboxUrl }: { lightboxUrl: string | null; setLightboxUrl: (v: string | null) => void }) {
  return (
