    ...
    <div className="flex w-full h-full bg-background text-foreground">
      <div className="w-1/2 border-r flex flex-col">
        <div className="p-4 border-b flex justify-between items-center shadow-sm">
          <Input value={template.name} onChange={e => setTemplate({...template, name: e.target.value})} className="font-bold border-transparent hover:border-input focus:border-input w-1/2" />
          <div className="flex gap-2">
            <Button variant="outline" size="sm" onClick={handleTest} disabled={testing}>{testing ? 'Enviando...' : 'Enviar Teste pra mim'}</Button>
      ...
      <div className="w-1/2 bg-muted/30 flex flex-col relative">
        ...
        <div className="flex-1 p-8 overflow-y-auto flex justify-center items-start hide-scrollbar">
