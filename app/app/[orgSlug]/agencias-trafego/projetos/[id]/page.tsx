...
import ProjectDetailShell from '@/components/features/agencias-trafego/projetos/ProjectDetailShell'
...
export default async function ProjetoDetailPage({ params }: { params: { orgSlug: string; id: string } }) {
  ...
  if (!project) redirect(`/app/${params.orgSlug}/agencias-trafego/projetos`)
