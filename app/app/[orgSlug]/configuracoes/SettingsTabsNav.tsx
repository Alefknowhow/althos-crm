...
import { Building, Building2, UsersRound, CreditCard, Palette, Share2, Bell, ShieldCheck } from 'lucide-react'
...
const TABS = [
  ...
  { key: 'organizacoes', label: 'Organizações', icon: Building2,   seg: 'organizacoes' },
