    ...
    <SiteShell>
      ...
      <section className="relative mx-auto max-w-4xl px-4 pb-20 sm:px-6">
        <div className="relative">
          {/* Linha conectora */}
          <div className="pointer-events-none absolute left-[27px] top-4 bottom-4 hidden w-px bg-gradient-to-b from-blue-500/40 via-white/10 to-transparent sm:block" />
          <div className="space-y-5">
            {HOW_IT_WORKS.map(s => (
              <div
                key={s.number}
                className="relative flex gap-5 rounded-2xl border border-white/10 bg-white/[0.02] p-6 sm:p-7"
              >
      ...
      <section className="relative mx-auto max-w-3xl px-4 pb-24 text-center sm:px-6">
        <h2 className="text-2xl font-bold text-white sm:text-3xl">Comece hoje mesmo</h2>
