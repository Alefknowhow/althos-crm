  ...
  return (
    <SiteShell>
      ...
      <section className="relative mx-auto max-w-5xl px-4 pb-20 sm:px-6">
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {DIFFERENTIATORS.map(d => (
            <div
              key={d.title}
              className="rounded-none border border-slate-200 bg-white p-6   transition-colors hover:border-[#78a9ff]"
            >
      ...
      <section className="relative mx-auto max-w-3xl px-4 pb-20 sm:px-6">
        <div className="rounded-none border border-slate-200 bg-white p-7   sm:p-9">
          ...
          <div className="mt-7 grid gap-5 sm:grid-cols-2">
            ...
            <div className="rounded-none border border-[#a6c8ff] bg-[#edf5ff] p-5">
              <p className="text-[13px] font-semibold text-[#0043ce]">Com o Althos</p>
