...
import { processAutomationEvent, processAutomationEventVerticals, processAutomationEventVerticals2, processAutomationEventTraffic, executeAutomationRun } from '@/lib/inngest/automation'
...
import { automationStaleLeadsFn, automationTaskOverdueFn, automationCustomerBirthdayFn, automationEmbarqueScheduledFn } from '@/lib/inngest/automation-crons'
import { automationRelativeDateFn } from '@/lib/inngest/automation-relative-date'
...
import { placeVoiceCallFn } from '@/lib/inngest/voice-calls'
import { voiceCallRetryFn } from '@/lib/inngest/voice-call-retry'
...
export const { GET, POST, PUT } = serve({
  ...
  functions: [
    ...
    automationEmbarqueScheduledFn,
    automationRelativeDateFn,
    trialWarningEmailFn,
    trialExpiredEmailFn,
    ...
    voiceCallRetryFn,
    sendVoiceSmsFn,
    requestVoiceTranscriptionFn,
    generateCallInsightsFn,
  ]
})
